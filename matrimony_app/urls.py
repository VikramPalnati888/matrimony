...
urlpatterns = [
				...
				path('smoke_Hobbit/',Smoke_HobbitView.as_view(), name="Pp Matches"),
				path('rasi/',RasiView.as_view(), name="Pp Matches"),
				path('qualification/',QualificationView.as_view(), name="Pp Matches"),
				path('post_graduation/',Post_graduationView.as_view(), name="Pp Matches"),
				path('profession/',ProfessionView.as_view(), name="Pp Matches"),
